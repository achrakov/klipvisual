...
export const featuredProjects = [
  projects.find((p) => p.slug === "lebalcon-events")!,
  projects.find((p) => p.slug === "boudchart-lolympia")!,
  projects.find((p) => p.slug === "culinary-photography")!,
]
