    ...
    <>
      <main style={{ background: "#0a0a0a", minHeight: "100vh" }}>
        ...
        >
          <div className="m-hide" style={{ position: "relative", overflow: "hidden" }}>
            <motion.div style={{ position: "absolute", inset: 0, y: leftY }}>
              ...
              >
                ...
                <img src={`${CDN}/675eb91e5fafbd1f37953c10_savoy.webp`} alt="" style={{ width: "100%", height: "100%", objectFit: "cover", display: "block" }} draggable={false} />
          ...
          <motion.div
            style={{ display: "flex", flexDirection: "column", justifyContent: "center", alignItems: "center", padding: "0 2.5rem", textAlign: "center", y: textY, position: "relative", zIndex: 5 }}
          >
            <motion.p
          ...
          <div className="m-hide" style={{ position: "relative", overflow: "hidden" }}>
            <motion.div style={{ position: "absolute", inset: 0, y: rightY }}>
              ...
              >
                {/* eslint-disable-next-line @next/next/no-img-element */}
                <img src={`${CDN}/67923c109ebd8d8a03e4960c_moon.jpg`} alt="" style={{ width: "100%", height: "100%", objectFit: "cover", display: "block" }} draggable={false} />
                <div style={{ position: "absolute", inset: 0, background: "rgba(10,10,10,0.3)" }} />
              </motion.div>
            </motion.div>
          </div>
          ...
          <motion.div
            ...
            style={{ position: "absolute", bottom: "2rem", left: "50%", transform: "translateX(-50%)", display: "flex", flexDirection: "column", alignItems: "center", gap: "0.5rem", pointerEvents: "none" }}
          >
          ...
          <div style={{ maxWidth: 1200, margin: "0 auto" }}>
            ...
            <div className="m-stack m-gap" style={{ display: "grid", gridTemplateColumns: "1fr 1.6fr", gap: "5rem", alignItems: "start" }}>
              ...
              >
                ...
                >
                  Achraf<br /><span style={{ color: "#E8181C" }}>Chibane</span>
                </h2>
          ...
          <div className="m-stack-2" style={{ display: "grid", gridTemplateColumns: "repeat(4, 1fr)" }}>
            {ta.stats.map((stat, i) => (
              <motion.div
                ...
                style={{ padding: "4rem 2.5rem", borderRight: i < ta.stats.length - 1 ? "1px solid #1f1f1f" : "none" }}
              >
          ...
          <div style={{ maxWidth: 1100, margin: "0 auto" }}>
            <div style={{ display: "flex", justifyContent: "center", marginBottom: "3.5rem" }}>
              <div style={{ position: "relative" }}>
                <span style={{ position: "absolute", left: -11, top: "50%", transform: "translateY(-50%)", width: 20, height: 20, borderRadius: "50%", background: "#0a0a0a", border: "1px solid rgba(240,237,232,0.18)", zIndex: 2 }} />
                <div
                  className="font-mono uppercase"
                  style={{ border: "1px solid rgba(240,237,232,0.18)", padding: "0.6rem 2rem", fontSize: "0.52rem", letterSpacing: "0.38em", color: "rgba(240,237,232,0.5)", background: "transparent", whiteSpace: "nowrap" }}
                >
                  {ta.services.label}
                </div>
                <span style={{ position: "absolute", right: -11, top: "50%", transform: "translateY(-50%)", width: 20, height: 20, borderRadius: "50%", background: "#0a0a0a", border: "1px solid rgba(240,237,232,0.18)", zIndex: 2 }} />
              </div>
            </div>
            ...
            <div className="m-stack" style={{ display: "grid", gridTemplateColumns: "1fr 1fr", border: "1px dashed rgba(240,237,232,0.2)", borderRadius: 8, overflow: "hidden" }}>
              {ta.services.items.map((svc, i) => (
                ...
                >
                  ...
                  />
                  <div style={{ position: "relative", zIndex: 1, background: "#e8e3d8", padding: "0.65rem 1.4rem", borderBottom: "1px solid rgba(0,0,0,0.08)" }}>
                    <span className="font-mono uppercase" style={{ fontSize: "0.48rem", letterSpacing: "0.3em", color: "rgba(0,0,0,0.4)" }}>
                  ...
                  <div style={{ position: "relative", zIndex: 1, padding: "3.5rem 2.5rem 4rem" }}>
                    <h3
                      className="font-display font-bold uppercase"
                      style={{ fontSize: "clamp(2rem, 3.8vw, 4.4rem)", lineHeight: "0.88em", letterSpacing: "-0.03em", color: "#f0ede8" }}
                    >
        ...
        <section style={{ position: "relative", height: "80vh", overflow: "hidden", display: "flex", alignItems: "center", justifyContent: "center" }}>
          {/* eslint-disable-next-line @next/next/no-img-element */}
          <img src={`${CDN}/675eb91e5fafbd1f37953c10_savoy.webp`} alt="" style={{ position: "absolute", inset: 0, width: "100%", height: "100%", objectFit: "cover", objectPosition: "center" }} draggable={false} />
          ...
          >
            ...
            >
              <span className="absolute inset-0 bg-[#E8181C] translate-y-full group-hover:translate-y-0 transition-transform duration-500" style={{ transitionTimingFunction: "cubic-bezier(0.22,1,0.36,1)" }} />
              <span className="font-mono uppercase relative z-10" style={{ padding: "14px 28px", fontSize: "0.55rem", letterSpacing: "0.32em", color: "#f0ede8", display: "flex", alignItems: "center" }}>
                {ta.ourWork.explore}
              </span>
              <span style={{ width: 1, background: "rgba(240,237,232,0.45)", flexShrink: 0, position: "relative", zIndex: 10 }} />
              <span className="relative z-10 flex items-center justify-center" style={{ padding: "14px 18px", color: "#f0ede8", fontSize: "0.9rem" }}>→</span>
            </Link>
          </motion.div>
        </section>
