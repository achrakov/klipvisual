        ...
        <div style={{ maxWidth: 720, margin: "0 auto", padding: "0 40px 96px" }}>
          ...
          <div style={{ display: "flex", gap: 24, marginBottom: 40 }}>
            {[{ href: "/cookie", label: "Cookie" }, { href: "/terms", label: "Terms" }, { href: "/privacy", label: "Privacy" }].map(({ href, label }) => (
              <Link key={href} href={href} className="font-mono uppercase" style={{ fontSize: 10, letterSpacing: "0.2em", color: href === "/cookie" ? "#f0ede8" : "#333", borderBottom: href === "/cookie" ? "1px solid #E8181C" : "1px solid transparent", paddingBottom: 4, transition: "color 0.2s" }}>
                {label}
              </Link>
            ))}
          </div>
